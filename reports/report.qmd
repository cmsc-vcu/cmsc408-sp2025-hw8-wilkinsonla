...
from world_bank_data.wdi_country
where country_region = 'North America' and is_country = 1
...
from world_bank_data.wdi_country
where country_abbr is not null and country_wb_abbr is not null
...
run_sql_and_return_html(cnx,"""
select income_category, count(*) as num_countries
from world_bank_data.wdi_country
where is_country = 1
...
This assignment was definitely a major learning experience. The biggest takeaways for me was that complex queries can be broken down into smaller queries that combine to do something more complicated, much similar to functions or methods in a larger program. I think these skills will be incredibly helpful for the future when I have to work with databased more often, and this will be helpful next semester when I begin Capstone because being able to analyze and transform data is a valuable skill to have.
